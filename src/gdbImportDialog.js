...
import {
  ...
  TARGET_UNASSIGNED,
  FLOOR_ALL,
  buildBuildingSelect as buildBuildingSelectShared,
  buildFloorSelect as buildFloorSelectShared,
...
export function openGdbImportDialog({ featureCollections, buildings, onImport, mode = "import" }) {
  ...
  function buildBuildingSelect(initialValue) {
    return buildBuildingSelectShared(buildings, initialValue);
  }

  function buildFloorSelect(buildingValue, initialValue) {
    return buildFloorSelectShared(buildings, buildingValue, initialValue);
  }
  ...
  function buildingIndexFromValue(value) {
    return buildingIndexFromValueShared(buildings, value);
  }
