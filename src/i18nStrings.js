...
const en = {
  ...
  "venue.exportWebsite": "Export for website",
  "venue.exportWebsiteBusy": "Building website bundle…",
  "venue.exportWebsiteDone": "Exported {name} as a website bundle ({count} files).",
...
const ja = {
  ...
  "venue.exportWebsite": "Webサイト用にエクスポート",
  "venue.exportWebsiteBusy": "Webサイト用バンドルを作成中…",
  "venue.exportWebsiteDone": "{name} をWebサイト用バンドルとして書き出しました（{count} ファイル）。",
  "venue.exportWebsiteNoTiles":
